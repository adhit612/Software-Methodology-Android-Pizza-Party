...
/**
 * Class that manages activity for CurrentOrder class.
...
public class CurrentOrderActivity extends AppCompatActivity {
    ...
    /**
     * Method to setup basic functions for current order.
     * @param savedInstanceState state of the program.
     */
    @Override
    ...
    /**
     * Helper method to set up all UI objects.
     */
    ...
    /**
     * On Action Listener to remove a pizza from current order.
     */
        ...
        currentOrderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(!removePizzaSwitch.isChecked()) {
                    ...
                    ArrayList<Pizza> currentOrderPizzas = currOrder.getPizzaList();
                    ArrayAdapter<Pizza> pizzaAdapter = new ArrayAdapter<>(view.getContext(),
                            android.R.layout.simple_list_item_1, currentOrderPizzas);
                    currentOrderList.setAdapter(pizzaAdapter);
                    subtotalLabel.setText(String.valueOf(currOrder.getTotalPriceWithoutTax()));
                    salesTaxLabel.setText(String.valueOf(currOrder.getSalesTaxOfTotal()));
    ...
    /**
     * On Action Listener to go back to Main Menu.
     * @param view current view for action.
     */
    ...
    /**
     * On Action Listener for adding to order button.
     * @param view current view for action.
     */
    ...
    /**
     * Method to generate order confirmation Alert Dialog.
     */
